...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="resources/main/index2.html" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>DU</b>J</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>DoU</b>Jo</span>
    </a>
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="resources/main/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="resources/main/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
