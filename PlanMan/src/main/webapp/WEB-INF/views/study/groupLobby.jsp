          ...
          <div class="box box-info" style="margin-left: 20px;"> 
            ...
            <div class="box-body no-padding"> 
              <ul class="nav nav-pills nav-stacked"> 
               		<li><a href="#" id="showmygroup" onclick="showMyGroup()"><i class="fa fa-file-text-o"></i>My Group</a></li>
               		<li><a href="#" id="showsearchgroup" onclick="showSearchGroup()"><i class="fa fa-file-text-o"></i>Group search</a></li>	
                	<li><a href="#" id="showmakegroup" onclick="showMakeGroup()"><i class="fa fa-file-text-o"></i>Group make</a></li>
              </ul> 
            </div> 
            <!-- /.box-body --> 
          </div> 
